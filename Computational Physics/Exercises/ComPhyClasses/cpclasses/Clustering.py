...
class AtomicCluster_2():
    ...
    def draw(self, ax, offset = [0,0], ms = 30, descriptor = False, set_color = None):
        ...
        circles = []
        for pos in self.pos:
            circle = mpatches.Circle(pos + offset, 0.4, facecolor=self._color, edgecolor='black', alpha = 0.5)

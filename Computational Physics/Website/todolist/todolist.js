const predefinedTasks = ['Complete all exercises', 
    'Finish all figures (and make them nice)', 
    'Make the code readable (including Markdown comments)', 
    "Setup this week's portfolio",
    "Make Thumbnail"];
const totalWeeks = 14;
